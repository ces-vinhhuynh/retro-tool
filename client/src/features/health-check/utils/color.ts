...
> = {
  ...
  1: { bg: 'bg-[#f7d0c2]', circle: 'bg-red-600', text: 'text-red-600' },
  2: { bg: 'bg-[#f9d8c1]', circle: 'bg-red-500', text: 'text-red-500' },
  3: { bg: 'bg-[#f9dfc0]', circle: 'bg-orange-500', text: 'text-orange-500' },
  4: { bg: 'bg-[#f9e5bf]', circle: 'bg-orange-400', text: 'text-orange-400' },
  5: { bg: 'bg-[#fae9bf]', circle: 'bg-yellow-400', text: 'text-yellow-400' },
  6: { bg: 'bg-[#f4eabe]', circle: 'bg-yellow-400', text: 'text-yellow-400' },
  7: { bg: 'bg-[#f4f2c6]', circle: 'bg-lime-400', text: 'text-lime-400' },
  8: { bg: 'bg-[#eff4ca]', circle: 'bg-green-400', text: 'text-green-400' },
  9: { bg: 'bg-[#e7f1cc]', circle: 'bg-green-500', text: 'text-green-500' },
  10: { bg: 'bg-[#dfedcf]', circle: 'bg-green-600', text: 'text-green-600' },
};
